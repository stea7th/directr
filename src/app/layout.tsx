...
export const metadata: Metadata = {
  ...
  description: "Directr learns how you create, decides what you should film today, builds the direction, and guides you through filming it.",
  ...
  openGraph: {
    ...
    description: "Stop deciding. Directr picks what to film and directs the shoot.",
    url: "/",
    siteName: "Directr",
          ...
          <div className="nav__inner">
            ...
            {user ? (
              ...
              <nav className="public-nav" aria-label="Public navigation">
                ...
                <Link href="/login?mode=signup&next=%2Fonboarding" className="public-nav__cta">Get today&apos;s direction <span aria-hidden="true">→</span></Link>
              </nav>
            )}
          </div>
        </header>
